      ...
      <div class="panel-body">
        <div class="row">
          ...
          <div class="col-lg-5">
            <b>HOW TO USE:</b>
            <p>
              - This page lists all the handover history of any laptop assets.
              <br>- If you want to hand an asset over to other person, you can procceed to specific laptop page on Handover section.
            </p>
          </div>
