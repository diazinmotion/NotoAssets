        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <table id="table-content" class="table table-bordered table-hover">
              <thead>
                <tr>
                  <th class="bg-primary text-center">Code</th>
                  <th class="bg-primary">Name</th>
                  <th class="bg-primary">Software List</th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal main-form">
          ...
          <div class="form-group row">
            <label class="col-sm-3 control-label">Software List</label>
            <div class="col-sm-9">
              <select name="list[]" id="software_list"></select>
            </div>
          </div>
        </form>
      </div>
...
<script>
  ...
  var table_columns   = ['code', 'name', 'list', 'action'];
