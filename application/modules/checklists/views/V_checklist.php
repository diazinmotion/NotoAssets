          ...
          <div class="col-lg-6 text-right">
            <div class="btn-group">
              <a href="javascript:void(0)" class="btn btn-success btn-sm btn-item-add">
                <i class="fa fa-plus fa-fw"></i> New Checklist
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <table id="table-content" class="table table-bordered table-hover">
              <thead>
                <tr>
                  <th class="bg-primary">Checklist Name</th>
                  <th class="bg-primary text-center" style="width:10%">Tasks Count</th>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        ...
        <h4 class="modal-title text-bold">New Checklist</h4>
      </div>
      <div class="modal-body">
        <form class="form-horizontal main-form">
          ...
          <div class="row" style="margin-bottom:10px;">
            <div class="col-lg-12"><hr style="padding:0;margin:0;"></div>
          </div>
          <div class="row">
            <div class="col-lg-12 tasks-box">
              <div class="input-group tasks" style="margin-top:10px;">
                <input type="text" name="task_name[uid]" class="form-control task_name" placeholder="Input data">
                <span class="input-group-addon bg-red btn-task-delete" style="cursor:pointer;">
                  <i class="fa fa-times fa-fw"></i>
                </span>
              </div>
            </div>
            <div class="col-lg-12 text-right" style="margin-top:10px;">
              <a href="javascript:void(0)" class="btn btn-xs btn-primary btn-task-add">Add Task</a>
            </div>
          </div>
        </form>
      </div>
...
<!-- START STYLES -->
<style>
  table.table-bordered.dataTable tbody td { vertical-align: top; }
</style>
<!-- END STYLES -->
...
<script>
  ...
  var table_columns   = ['name', 'tasks', 'action'];
